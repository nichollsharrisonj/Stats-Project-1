...
```{r,echo=FALSE,warning=FALSE}
grid.arrange(plot6 + ggtitle("Figure 7"), plot15 + ggtitle("Figure 8"), ncol=2)
```
...
```{r,echo=FALSE,warning=FALSE}
grid.arrange(plot7 + ggtitle("Figure 9"), plot16 + ggtitle("Figure 10"), ncol=2)
```
