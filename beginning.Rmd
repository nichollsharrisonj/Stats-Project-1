...
ggplot (data=cia, aes(x=internet_users/population, y=life_exp_at_birth)) + geom_point(aes(color = continent)) + xlab('Internet users / population') + ylab('Life Expentancy at birth')
```
...
```{r, echo = FALSE, warning=FALSE}
ggplot (data=cia, aes(x=birth_rate, y=life_exp_at_birth)) + geom_point(aes(color = continent))
```
