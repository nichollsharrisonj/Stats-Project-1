...
Proportion of population using the internet vs life expectancy (With birth rate as color, which we may or may not keep)

```{r,echo=FALSE,warning=FALSE}
ggplot (data=cia, aes(x=internet_users/population, y=life_exp_at_birth)) + geom_point(aes(color = birth_rate)) + xlab('Internet users / population') + ylab('Life Expentancy at birth')
```
...
Lee, Cheng-Wen, [The Relationship between Internet Environment and Life Expectancy in Asia
	Article](http://buscompress.com/uploads/3/4/9/8/34980536/riber_8-2_06_m18-053_70-80.pdf) explores this question specifically in Asia, with relevant take-away in emphasising the disparity between countries with advanced telecommunication services and those without in regards to their general economic development in a globalized market.
